...
const docTemplate = `{
    ...
    "paths": {
        ...
        "/api/v2/markets/{id}/floors/published": {
            "get": {
                "consumes": [
                    "application/json"
                ],
        ...
        "/api/v2/markets/{id}/stalls/count": {
            "get": {
                "consumes": [
                    "application/json"
                ],
                ...
                "responses": {
                    "200": {
                        "description": "OK",
                        "schema": {
                            "$ref": "#/definitions/controller.CountStallsResponse"
                        }
                    },
                    "400": {
                        "description": "Bad Request",
    ...
    "definitions": {
        ...
        "controller.CountStallsResponse": {
            "type": "object",
            "properties": {
                "available_stalls": {
                    "type": "integer"
