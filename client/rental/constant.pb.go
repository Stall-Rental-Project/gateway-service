...
const (
	...
	LeaseStatus_RENEWED         LeaseStatus = 5
)
...
const (
	...
	ApplicationType_TRANSFER_STALL_APP                 ApplicationType = 2
	ApplicationType_STALL_EXTENSION                    ApplicationType = 4
	ApplicationType_REPAIR_PERMIT                      ApplicationType = 5
	ApplicationType_APP_TO_FRANCHISE                   ApplicationType = 6
	ApplicationType_RENEWAL_APP_TO_FRANCHISE           ApplicationType = 7
	ApplicationType_HAWKER_REGISTRATION_APP            ApplicationType = 8
	ApplicationType_HAWKER_PERMIT_APP                  ApplicationType = 9
	ApplicationType_RENEWAL_HAWKER_PERMIT_APP          ApplicationType = 10
	ApplicationType_RENEWAL_HAWKER_PERMIT_REGISTRATION ApplicationType = 11
	ApplicationType_HAWKER_ASSOCIATION                 ApplicationType = 12
	ApplicationType_MARKET_OPERATOR_APP                ApplicationType = 13
	ApplicationType_RENEWAL_MARKET_OPERATOR_APP        ApplicationType = 14
	ApplicationType_MANAGE_MARKET_OPERATOR             ApplicationType = 15
)
...
var (
	ApplicationType_name = map[int32]string{
		0:  "NEW_STALL_APP",
		1:  "RENEWAL_STALL_APP",
		2:  "TRANSFER_STALL_APP",
		4:  "STALL_EXTENSION",
		5:  "REPAIR_PERMIT",
		6:  "APP_TO_FRANCHISE",
		7:  "RENEWAL_APP_TO_FRANCHISE",
		8:  "HAWKER_REGISTRATION_APP",
		9:  "HAWKER_PERMIT_APP",
		10: "RENEWAL_HAWKER_PERMIT_APP",
		11: "RENEWAL_HAWKER_PERMIT_REGISTRATION",
		12: "HAWKER_ASSOCIATION",
		13: "MARKET_OPERATOR_APP",
		14: "RENEWAL_MARKET_OPERATOR_APP",
		15: "MANAGE_MARKET_OPERATOR",
	}
	ApplicationType_value = map[string]int32{
		"NEW_STALL_APP":                      0,
		"RENEWAL_STALL_APP":                  1,
		"TRANSFER_STALL_APP":                 2,
		"STALL_EXTENSION":                    4,
		"REPAIR_PERMIT":                      5,
		"APP_TO_FRANCHISE":                   6,
		"RENEWAL_APP_TO_FRANCHISE":           7,
		"HAWKER_REGISTRATION_APP":            8,
		"HAWKER_PERMIT_APP":                  9,
		"RENEWAL_HAWKER_PERMIT_APP":          10,
		"RENEWAL_HAWKER_PERMIT_REGISTRATION": 11,
		"HAWKER_ASSOCIATION":                 12,
		"MARKET_OPERATOR_APP":                13,
		"RENEWAL_MARKET_OPERATOR_APP":        14,
		"MANAGE_MARKET_OPERATOR":             15,
	}
)
...
const (
	WorkflowStatus_ACCEPT_RECOMMENDATION         WorkflowStatus = 0
	WorkflowStatus_ADDITIONAL_INFO_REQUESTED     WorkflowStatus = 1
	WorkflowStatus_APPEAL_SUBMITTED              WorkflowStatus = 2
	WorkflowStatus_APPROVED                      WorkflowStatus = 3
	WorkflowStatus_CLEARED                       WorkflowStatus = 4
	WorkflowStatus_CLOSED                        WorkflowStatus = 5
	WorkflowStatus_DISAPPROVED                   WorkflowStatus = 6
	WorkflowStatus_FOR_CLEARANCE                 WorkflowStatus = 7
	WorkflowStatus_FOR_FINAL_APPROVAL            WorkflowStatus = 8
	WorkflowStatus_FOR_INTERVIEW                 WorkflowStatus = 9
	WorkflowStatus_FOR_MARKET_CLASSIFICATION     WorkflowStatus = 10
	WorkflowStatus_FOR_PAYMENT_VERIFICATION      WorkflowStatus = 11
	WorkflowStatus_FOR_REVIEW                    WorkflowStatus = 12
	WorkflowStatus_IN_PROGRESS                   WorkflowStatus = 13
	WorkflowStatus_MARKET_CLASSIFIED             WorkflowStatus = 14
	WorkflowStatus_NEW                           WorkflowStatus = 15
	WorkflowStatus_PAYMENT_CONFIRMED             WorkflowStatus = 16
	WorkflowStatus_PENDING_PAYMENT               WorkflowStatus = 17
	WorkflowStatus_REVIEWED                      WorkflowStatus = 18
	WorkflowStatus_PAYMENT_INFO_REQUESTED        WorkflowStatus = 19
	WorkflowStatus_CANCELLED                     WorkflowStatus = 20
	WorkflowStatus_EXPIRED                       WorkflowStatus = 21
	WorkflowStatus_FOR_INSPECTION                WorkflowStatus = 22
	WorkflowStatus_PENDING_SETTLEMENT            WorkflowStatus = 23
	WorkflowStatus_VENDING_INFORMATION_REQUESTED WorkflowStatus = 24
	WorkflowStatus_FOR_RECOMMENDATORY_APPROVAL   WorkflowStatus = 25
	WorkflowStatus_FOR_INITIAL_REVIEW            WorkflowStatus = 26
	WorkflowStatus_INFORMATION_REQUESTED         WorkflowStatus = 27
)

// Enum value maps for WorkflowStatus.
var (
	WorkflowStatus_name = map[int32]string{
		0:  "ACCEPT_RECOMMENDATION",
		1:  "ADDITIONAL_INFO_REQUESTED",
		2:  "APPEAL_SUBMITTED",
		3:  "APPROVED",
		4:  "CLEARED",
		5:  "CLOSED",
		6:  "DISAPPROVED",
		7:  "FOR_CLEARANCE",
		8:  "FOR_FINAL_APPROVAL",
		9:  "FOR_INTERVIEW",
		10: "FOR_MARKET_CLASSIFICATION",
		11: "FOR_PAYMENT_VERIFICATION",
		12: "FOR_REVIEW",
		13: "IN_PROGRESS",
		14: "MARKET_CLASSIFIED",
		15: "NEW",
		16: "PAYMENT_CONFIRMED",
		17: "PENDING_PAYMENT",
		18: "REVIEWED",
		19: "PAYMENT_INFO_REQUESTED",
		20: "CANCELLED",
		21: "EXPIRED",
		22: "FOR_INSPECTION",
		23: "PENDING_SETTLEMENT",
		24: "VENDING_INFORMATION_REQUESTED",
		25: "FOR_RECOMMENDATORY_APPROVAL",
		26: "FOR_INITIAL_REVIEW",
		27: "INFORMATION_REQUESTED",
	}
	WorkflowStatus_value = map[string]int32{
		...
		"DISAPPROVED":                   6,
		"FOR_CLEARANCE":                 7,
		"FOR_FINAL_APPROVAL":            8,
		"FOR_INTERVIEW":                 9,
		"FOR_MARKET_CLASSIFICATION":     10,
		"FOR_PAYMENT_VERIFICATION":      11,
		"FOR_REVIEW":                    12,
		"IN_PROGRESS":                   13,
		"MARKET_CLASSIFIED":             14,
		"NEW":                           15,
		"PAYMENT_CONFIRMED":             16,
		"PENDING_PAYMENT":               17,
		"REVIEWED":                      18,
		"PAYMENT_INFO_REQUESTED":        19,
		"CANCELLED":                     20,
		"EXPIRED":                       21,
		"FOR_INSPECTION":                22,
		"PENDING_SETTLEMENT":            23,
		"VENDING_INFORMATION_REQUESTED": 24,
		"FOR_RECOMMENDATORY_APPROVAL":   25,
		"FOR_INITIAL_REVIEW":            26,
		"INFORMATION_REQUESTED":         27,
	}
)
...
type Application struct {
	...
	Status        int32              `protobuf:"varint,19,opt,name=status,proto3" json:"status"` // references to WorkflowStatus enum
	...
	LeaseEndDate         string        `protobuf:"bytes,62,opt,name=lease_end_date,json=leaseEndDate,proto3" json:"lease_end_date"`
...
var file_rental_constant_proto_rawDesc = []byte{
	...
	0x72, 0x49, 0x64, 0x22, 0xea, 0x10, 0x0a, 0x0b, 0x41, 0x70, 0x70, 0x6c, 0x69, 0x63, 0x61, 0x74,
	...
	0x61, 0x74, 0x75, 0x73, 0x12, 0x28, 0x0a, 0x07, 0x6d, 0x65, 0x6d, 0x62, 0x65, 0x72, 0x73, 0x18,
	0x14, 0x20, 0x03, 0x28, 0x0b, 0x32, 0x0e, 0x2e, 0x72, 0x65, 0x6e, 0x74, 0x61, 0x6c, 0x2e, 0x4d,
	...
	,
	...
	,
	...
	0x73, 0x74, 0x61, 0x74, 0x75, 0x73, 0x18, 0x05, 0x20, 0x01, 0x28, 0x05, 0x52, 0x0d, 0x6d, 0x61,
	0x72, 0x69, 0x74, 0x61, 0x6c, 0x53, 0x74, 0x61, 0x74, 0x75, 0x73, 0x12, 0x22, 0x0a, 0x0d, 0x64,
	...
	,
	...
	0x63, 0x69, 0x74, 0x79, 0x12, 0x12, 0x0a, 0x04, 0x77, 0x61, 0x72, 0x64, 0x18, 0x12, 0x20, 0x01,
	0x28, 0x09, 0x52, 0x04, 0x77, 0x61, 0x72, 0x64, 0x12, 0x18, 0x0a, 0x07, 0x7a, 0x69, 0x70, 0x63,
	0x6f, 0x64, 0x65, 0x18, 0x13, 0x20, 0x01, 0x28, 0x09, 0x52, 0x07, 0x7a, 0x69, 0x70, 0x63, 0x6f,
	0x64, 0x65, 0x12, 0x14, 0x0a, 0x05, 0x65, 0x6d, 0x61, 0x69, 0x6c, 0x18, 0x15, 0x20, 0x01, 0x28,
	...
	0x64, 0x12, 0x10, 0x0a, 0x03, 0x61, 0x67, 0x65, 0x18, 0x17, 0x20, 0x01, 0x28, 0x05, 0x52, 0x03,
	0x61, 0x67, 0x65, 0x12, 0x1a, 0x0a, 0x08, 0x64, 0x69, 0x73, 0x74, 0x72, 0x69, 0x63, 0x74, 0x18,
	0x18, 0x20, 0x01, 0x28, 0x09, 0x52, 0x08, 0x64, 0x69, 0x73, 0x74, 0x72, 0x69, 0x63, 0x74, 0x2a,
	...
	,
	...
	,
...
var file_rental_constant_proto_enumTypes = make([]protoimpl.EnumInfo, 9)
...
var file_rental_constant_proto_goTypes = []interface{}{
	...
	(Sex)(0),                 // 2: rental.Sex
	(CivilStatus)(0),         // 3: rental.CivilStatus
	(PaymentStatus)(0),       // 4: rental.PaymentStatus
	(LeaseStatus)(0),         // 5: rental.LeaseStatus
	(ApplicationType)(0),     // 6: rental.ApplicationType
	(WorkflowStatus)(0),      // 7: rental.WorkflowStatus
	(PaymentMethod)(0),       // 8: rental.PaymentMethod
	(*Member)(nil),           // 9: rental.Member
	(*Application)(nil),      // 10: rental.Application
	(*ApplicationOwner)(nil), // 11: rental.ApplicationOwner
	(market.MarketType)(0),   // 12: market.MarketType
	(market.MarketClass)(0),  // 13: market.MarketClass
	(market.StallType)(0),    // 14: market.StallType
	(market.StallClass)(0),   // 15: market.StallClass
}
var file_rental_constant_proto_depIdxs = []int32{
	11, // 0: rental.Application.owner:type_name -> rental.ApplicationOwner
	12, // 1: rental.Application.market_type:type_name -> market.MarketType
	13, // 2: rental.Application.market_class:type_name -> market.MarketClass
	14, // 3: rental.Application.stall_type:type_name -> market.StallType
	15, // 4: rental.Application.stall_class:type_name -> market.StallClass
	6,  // 5: rental.Application.type:type_name -> rental.ApplicationType
	9,  // 6: rental.Application.members:type_name -> rental.Member
	8,  // 7: rental.Application.payment_method:type_name -> rental.PaymentMethod
	5,  // 8: rental.Application.lease_status:type_name -> rental.LeaseStatus
	4,  // 9: rental.Application.current_payment_status:type_name -> rental.PaymentStatus
